...
<head>
    ...
    <title>SnapCLOCK - Absensi SMK Bunda Auni</title>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link {{ request()->is('dashboard-guru*') ? 'active' : '' }}" href="{{url('/dashboard-guru')}}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link {{ request()->is('data-guru*') ? 'active' : '' }}, {{ request()->is('tambah-guru*') ? 'active' : '' }}" href="{{url('/data-guru')}}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link {{ request()->is('absensi-harian*') ? 'active' : '' }}" href="{{url('/absensi-harian')}}"
                                aria-expanded="false">
                                <i class="fa fa-user" aria-hidden="true"></i>
